...
//
//
//Effect Vostle Town Lake Path Sign Create
function scr_effect_vostleTown_sign_create(){
image_speed = 0;
sprite_index = spr_effect_sign_vostle;
...
//
//Effect Well Step
function scr_effect_vostleTown_sign(){
image_speed = 0;
depth = -y;
image_xscale = 1;
image_yscale = 1;
