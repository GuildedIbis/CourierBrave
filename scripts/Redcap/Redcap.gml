...
//
//Redcap Create
function scr_enemy_redcap_create(){
//Scripts
home_state = scr_enemy_redcap_free;
entity_step = scr_enemy_redcap_free;
entity_drop = scr_enemy_redcap_drop;

//Assets
enemy_idle = spr_enemy_redcap_idle;
enemy_move = spr_enemy_redcap_run;
enemy_damaged = spr_enemy_redcap_damaged;
...
//
//Redcap Spawn
function scr_enemy_redcap_spawn()
{
if (obj_game.gamePaused = false)
{
	...
	//Setup
	if (sprite_index != spr_enemy_redcap_spawn)
	{
...
//
//Redcap Free State
function scr_enemy_redcap_free(){
if (obj_game.gamePaused = false)
{
	//Timers
	...
	{
		lit = false;
		sprite_index = spr_enemy_redcap_buried;
	...
	if (targeted = true)
	{
		...
		if (point_in_circle(obj_player.x,obj_player.y,x,y,6))
		{
			...
			{
				//timer1 = 120;
				entity_step = scr_enemy_redcap_drainSpore;
...
//
//Redcap Drain Spore
function scr_enemy_redcap_drainSpore(){
if (obj_game.gamePaused = false)
{
	//Timers
	scr_enemy_timer_countdown();
	...
	//Setup
	if (sprite_index != spr_enemy_redcap_drainSpore)
	{
	...
	//Cacluate Attack
	damage = 25;
	scr_enemy_attack_calculate(spr_enemy_redcap_drainSpore_hitbox,self,-1,-1,-1,-1,-1,-1);
...
//
//Redcap Drop
function scr_enemy_redcap_drop(){
var _objects = 3;	
