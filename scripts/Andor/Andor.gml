...
if (obj_inventory.quest_grid[# 8, 0] = false)
{
	...
	{
		speaker = 1;
		text_string = "If you can get around the stone\n that is blocking the path, you might\nfind your Form Stone."
		_SubString = string_copy(text_string,1,letter_counter);
		draw_text_transformed(72,128,"Press E to Continue",.5,.5,0);
	}
	if (string_counter = 4)
...
if (obj_inventory.quest_grid[# 8, 1] < 3)
{
	...
	{
		speaker = 1;
		text_string = "If you can get around past the doors\n that are blocking the path, you might\nfind your Form Stone."
		_SubString = string_copy(text_string,1,letter_counter);
		draw_text_transformed(72,128,"Press E to Continue",.5,.5,0);
	}
	if (string_counter = 3)
