...
quest_grid[# 9, 4] = Idle;
quest_grid[# 9, 5] = "Ceriver's form stone found\n\nThe Rempho people are notoriously\npassionate about rivers and lakes, and Ceriver was no\nexception. He fell on the banks of Therulil in an\nimpossible defense against the hoards of\nthe Great Evil.";
quest_grid[# 9, 6] = "Rempho Prince of Lakes";
