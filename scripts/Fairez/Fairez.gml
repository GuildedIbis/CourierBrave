...
if (obj_inventory.quest_grid[# 10, 3] = true)
{
	...
	{
		speaker = 1;
		text_string = "I might stay a bit longer. It's an excellent\nfishing spot. Tell Orodry not to wait for me to have supper." 
		_SubString = string_copy(text_string,1,letter_counter);
	}
...
//
//Draw Inventory
function scr_menu_fairez_trade(){
...
{
	case 0:
		scr_menu_fairez_trade_page_0();
	break;
	
	case 1:
		scr_menu_fairez_trade_page_1();
	break;
}
...
//
//
//Draw Fairez Trade Menu 0
function scr_menu_fairez_trade_page_0(){
//Convert Mouse to GUI
var _mouseX = device_mouse_x_to_gui(0);
var _mouseY = device_mouse_y_to_gui(0);
...
//
//
//Draw Fairez Trade Menu 1
function scr_menu_fairez_trade_page_1(){
//Convert Mouse to GUI
var _mouseX = device_mouse_x_to_gui(0);
var _mouseY = device_mouse_y_to_gui(0);
