...
//
//Folio Bulb Create
function FolioTasarCreate(){
targeted = false;	
invincible = false;
inv_dur_timer = 0;
home_state = FolioTasarFree;
entity_step = home_state;
entity_drop = FolioTasarDrop;
			...
			switch (attack_chose)
			{
				case 0:
					...
					if (timer1 <= 0)
					{
						...
						timer1 = 90;
						entity_step = FolioTasarRootRise1;
					}
				break;
				...
				case 1:
					...
					if (timer1 <= 0)
					{
						audio_play_sound(snd_folioBulb_rootRise,0,false);
						timer1 = 90;
						entity_step = FolioTasarRootRise2;
					}
				break;
			}
		}
