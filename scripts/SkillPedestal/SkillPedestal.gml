...
shadow = true;
shadow_size = 2;
active_sprite = spr_skill_pedestal;
idle_sprite = spr_skill_pedestal_empty;
pedestal_index = 0;
}
//
//
...
//
//
//Skill Pedestal 4 Text
function scr_text_pedestal_skill_4(){
//Stone
draw_set_font(global.fnt_main_white);
draw_set_halign(fa_left)
draw_set_valign(fa_top)
...
{
	speaker = 1;
	text_string = "Green Skill Stone found!\nSpend Skill Stones in the Form Menu of the Inventory." 
	_SubString = string_copy(text_string,1,letter_counter);
	draw_text_transformed(68,28,"Press E to Continue",.5,.5,0);
}
...
//
//
//Skill Pedestal 5 Text
function scr_text_pedestal_skill_5(){
//Stone
draw_set_font(global.fnt_main_white);
draw_set_halign(fa_left)
draw_set_valign(fa_top)
...
{
	speaker = 1;
	text_string = "Red Skill Stone found!\nSpend Skill Stones in the Form Menu of the Inventory." 
	_SubString = string_copy(text_string,1,letter_counter);
	draw_text_transformed(68,28,"Press E to Continue",.5,.5,0);
}
