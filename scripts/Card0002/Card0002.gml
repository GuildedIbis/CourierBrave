...
function scr_cg_player_0002_hand_selectedP(){
...
//
//While Selected in Hand
function scr_cg_player_0002_hand_selectedS(){
var _mouseX = device_mouse_x_to_gui(0);
var _mouseY = device_mouse_y_to_gui(0);
...
//
//While Selected in Hand
function scr_cg_player_0002_active_selectedP(){
var _mouseX = device_mouse_x_to_gui(0);
var _mouseY = device_mouse_y_to_gui(0);
...
//
//While Selected in Hand
function scr_cg_player_0002_active_selectedS(){
var _mouseX = device_mouse_x_to_gui(0);
var _mouseY = device_mouse_y_to_gui(0);
...
//
//While Selected in Hand
function scr_cg_opp_0002_active_selectedP(){
var _mouseX = device_mouse_x_to_gui(0);
var _mouseY = device_mouse_y_to_gui(0);
...
//
//While Selected in Hand
function scr_cg_opp_0002_active_selectedS(){
var _mouseX = device_mouse_x_to_gui(0);
var _mouseY = device_mouse_y_to_gui(0);
