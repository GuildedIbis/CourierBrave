...
//
//
//Halofire Unlock Menu GUI
function scr_menu_skills_halofire_unlock(){
...
draw_text_transformed(160,39,"UNLOCK HALOFIRE?",1,1,0);
...
if (point_in_rectangle(_mouseX,_mouseY,193,112,229,128))
{
	...
	if (mouse_check_button_pressed(mb_left))
	{
		...
		inv_gui = obj_inventory.form_grid[# 1, 3];
		slot = 1;
	}
}
}
...
//
//
//Halofire Skills Menu GUI
function scr_menu_skills_halofire(){
//Get mouse location on GUI
var _mouseX = device_mouse_x_to_gui(0);
var _mouseY = device_mouse_y_to_gui(0);
...
draw_sprite_stretched(spr_menu_beveled,3,87,35,146,98);
draw_sprite_stretched(spr_menu,8,82,35,156,16);
draw_text_transformed(160,39,"HALOFIRE SKILLS",1,1,0);
