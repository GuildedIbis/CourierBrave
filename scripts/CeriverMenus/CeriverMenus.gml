...
function scr_menu_ceriver(){
//Convert Mouse to GUI
var _mouseX = device_mouse_x_to_gui(0);
var _mouseY = device_mouse_y_to_gui(0);
var _scriptList = array_create(4,-1)
_scriptList[0] = scr_menu_ceriver_armor;
_scriptList[1] = scr_menu_ceriver_weapon;
_scriptList[2] = scr_menu_ceriver_primary;
_scriptList[3] = scr_menu_ceriver_special;
...
draw_text_transformed(101,39,"CERIVER",1,1,0);
...
function scr_menu_ceriver_weapon(){
var _mouseX = device_mouse_x_to_gui(0);
var _mouseY = device_mouse_y_to_gui(0);	
var _midX = 222;
var _leftX = 167;
...
switch (obj_inventory.form_grid[# 3, 5])
{
	case 0:
		...
		draw_text_transformed(235,133,"1\n("+ string(obj_inventory.rog_array[3])+")",.5,.5,0);
...
function scr_menu_ceriver_armor(){
var _mouseX = device_mouse_x_to_gui(0);
var _mouseY = device_mouse_y_to_gui(0);	
var _midX = 222;
var _leftX = 167;
...
function scr_menu_ceriver_primary(){
var _mouseX = device_mouse_x_to_gui(0);
var _mouseY = device_mouse_y_to_gui(0);	
var _midX = 222;
var _leftX = 167;
...
if (obj_inventory.quest_grid[# 30, 3] = true)
{
	...
	if (page = 0) draw_sprite_ext(spr_primaryAlt_allGame,3,269,55,1,1,0,c_white,1);
	if (page = 1) draw_sprite_ext(spr_primary_allGame,3,269,55,1,1,0,c_white,1);
...
function scr_menu_ceriver_special(){
var _mouseX = device_mouse_x_to_gui(0);
var _mouseY = device_mouse_y_to_gui(0);	
var _midX = 222;
var _leftX = 167;
