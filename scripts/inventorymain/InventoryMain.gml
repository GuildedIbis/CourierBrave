...
//Button Mechanics
//if (point_in_rectangle(_mouseX,_mouseY,69,8,90,36))//Stats Menu
//{
...
if (point_in_rectangle(_mouseX,_mouseY,115,8,139,36))//Quest Menu
{
...
if (point_in_rectangle(_mouseX,_mouseY,138,8,159,36))//Map Menu
{
...
if (point_in_rectangle(_mouseX,_mouseY,161,8,182,36))//Info Menu
{
...
if (point_in_rectangle(_mouseX,_mouseY,184,8,205,36))//Exit
{
...
if (inv_gui != -1)
{
	script_execute(inv_gui);
}
//if (point_in_rectangle(_mouseX,_mouseY,230,8,251,36)) //Exit
//{
