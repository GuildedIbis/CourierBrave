...
if (obj_game.gamePaused = false)
{
	...
	if (targeted = true) and (thundux = false)
	{
		...
		if (dash_timer <= 0)
		{
			audio_sound_gain(snd_enemy_ofaWorm_dash,global.volumeEffects,1);
			audio_play_sound(snd_enemy_ofaWorm_dash,0,false);	
			dash_timer = 720;
			timer2 = 90;
		}
		if (timer2 > 0)
...
if (obj_game.gamePaused = false)
{
	...
	//Cacluate Attack
	damage = 20;
	scr_enemy_attack_calculate(spr_ofaWorm_headbutt_hitbox,self,-1,-1,-1,-1,-1,-1)
